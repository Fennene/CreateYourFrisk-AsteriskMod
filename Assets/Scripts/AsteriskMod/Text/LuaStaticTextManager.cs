...
namespace AsteriskMod
{
    public class LuaStaticTextManager : StaticTextManager
    {
        ...
        [Obsolete] private GameObject containerBubble = null;
        [Obsolete] private RectTransform speechThing = null;
        [Obsolete] private RectTransform speechThingShadow = null;
        [Obsolete] private DynValue bubbleLastVar = DynValue.NewNil();
        private const bool bubble = false;
        private int framesWait = 60;
        private int countFrames;
        [Obsolete] private int _bubbleHeight = -1;
        [Obsolete] private BubbleSide bubbleSide = BubbleSide.NONE;
