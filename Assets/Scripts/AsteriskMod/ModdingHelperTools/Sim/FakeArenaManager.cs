...
{
    internal class FakeArenaManager : MonoBehaviour
    {
        public Vector2 basisCoordinates;
        public static FakeArenaManager instance;
        ...
        public bool firstTurn = true, yup, falseInit; // yup??????
        ...
        {
            if (instance != null)
                throw new CYFException("Currently, the FakeArenaManager may only be attached to one object.");
        ...
        private void Start() { FakeLateUpdater.lateActions.Add(LateStart); }
        ...
        private void LateStart()
        {
            ...
            {
                FakeLateUpdater.lateActions.Add(LateStart);
