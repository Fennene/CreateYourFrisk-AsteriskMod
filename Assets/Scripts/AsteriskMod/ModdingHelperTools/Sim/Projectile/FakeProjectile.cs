...
{
    internal abstract class FakeProjectile : MonoBehaviour
    {
        //* internal Script owner;
        protected internal RectTransform self; // RectTransform of this projectile
        protected internal FakeProjectileController ctrl;
        ...
        private void Awake()
        {
            ...
            */
            ...
            ctrl = new FakeProjectileController(this);
        }
        ...
        private void OnEnable()
        {
            ...
            OnStart();
            if (FakePlayerController.instance.texture == null)
                FakePlayerController.instance.texture = ((Texture2D)FakePlayerController.instance.selfImg.mainTexture).GetPixels32();
        }

        /// <summary>
        /// Renew the attached Projectile Controller. This is done whenever this projectile is dequeued from the bullet pool.
        /// </summary>
        public void renewController() { ctrl = new FakeProjectileController(this); }
