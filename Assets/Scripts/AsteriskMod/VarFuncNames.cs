...
internal static class MonsterVar
{
    ...
    public const string FIGHT_MENU_FILL_BAR_COLOR = "menufillbarcolor";
    public const string FIGHT_MENU_FILL_BAR_ALPHA = "menufillbaralpha";

    public const string FIGHT_UI_BG_BAR_COLOR = "bgbarcolor";
    public const string FIGHT_UI_FILL_BAR_COLOR = "fillbarcolor";
