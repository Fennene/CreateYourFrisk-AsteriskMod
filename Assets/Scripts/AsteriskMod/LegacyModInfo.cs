...
namespace AsteriskMod
{
    ...
    public class LegacyModInfo
    {
        ...
        public static LegacyModInfo Get(string modDirName)
        {
            LegacyModInfo info = new LegacyModInfo();
            string path = Path.Combine(FileLoader.DataRoot, "Mods/" + modDirName + "/" + ModInfo.MODINFO_FILE_NAME);
        ...
        public static Font ConvertDisplayFont(DisplayFont displayFont)
        {
            return Resources.Load<Font>("Fonts/" + ((displayFont == DisplayFont.EightBitoperator) ? "8bitoperator_JVE/8bitoperator_jve" : "PixelOperator/PixelOperator-Bold"));
        }


        [ToDo("Useless! Useless! Useless! Useless! Useless! Useless! Useless!")]
        public static bool Exists(string modDirName)
        {
            return File.Exists(Path.Combine(FileLoader.DataRoot, "Mods/" + modDirName + "/" + ModInfo.MODINFO_FILE_NAME));
        }
        ...
        public LegacyModInfo Clone()
        {
            LegacyModInfo clone = new LegacyModInfo();
