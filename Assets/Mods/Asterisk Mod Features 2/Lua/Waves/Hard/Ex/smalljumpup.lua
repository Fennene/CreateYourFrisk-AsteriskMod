function OnHit(bullet) Encounter.Call("PlayerHurt", 4) end
...
function Update()
	...
	if frame_counter % 28 == 0 then CreatePole() end
	for i = 1, #toleft_bullets do toleft_bullets[i].Move(-6, 0) end
	for i = 1, #toright_bullets do toright_bullets[i].Move(6, 0) end
