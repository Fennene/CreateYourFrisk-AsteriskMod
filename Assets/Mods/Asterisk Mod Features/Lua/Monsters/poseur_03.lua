...
-- You can change color of HP Bar.
minibgcolor = {0, 0, 0} -- The color of HPBar's background in FIGHT menu (0~255)
bgcolor = {255, 100, 0} -- The color of HPBar's background (0~255)
fillcolor = {66, 226, 255} -- The color of HPBar that shows current enemy HP (0~255)
